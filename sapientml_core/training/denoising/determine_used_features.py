...
def compare_basic(project, static_info):
    """
    Create summary for each pipeline from dataset_snapshot.
    """
...
def main(test_mode=False):
    """
      Fetch all the pipeline details from json files in dataset_snapshots folder and summarize it and store in feature_analysis_summary.json
