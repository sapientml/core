...
# Validating  dataset_pkl  and replacing .py file with col_dumper file.
...
# Call dump_final_dataframe function and handles the exception
def _run(data):
...
# Getting all the pipeline details and parse the pipelines.
def main():
